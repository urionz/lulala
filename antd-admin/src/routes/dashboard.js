...
import RegAndSignIn from '../components/dashboard/regAndSignIn';
...
function Dashboard({dashboard, dispatch}) {
    const {weather, regAndSignIn, quote, numbers, recentSales, comments, completed, browser, cpu, user} = dashboard;
        ...
        <Row gutter={24}>
            ...
            <Col lg={18} md={24}>
                <Card bordered={false} bodyStyle={{
                    ...
                    <RegAndSignIn data={regAndSignIn}/>
                </Card>
            </Col>
            <Col lg={6} md={24}>
                <Row gutter={24}>
